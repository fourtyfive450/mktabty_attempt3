...
public class BooksForSaleAdapter extends RecyclerView.Adapter<BooksForSaleAdapter.MyViewHolder> {

    private FragmentBooksForSale mContext ;
    private List<BooksForSaleCaps> mData ;


    public BooksForSaleAdapter(FragmentBooksForSale mContext, List<BooksForSaleCaps> mData) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = mInflater.inflate(R.layout.books_for_sale_item,parent,false);
